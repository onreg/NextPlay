...
import io.github.onreg.data.details.impl.mapper.impl.GameDetailsDtoMapperImpl
import io.github.onreg.data.details.impl.mapper.impl.GameDetailsEntityMapperImpl
import javax.inject.Singleton

@Module
@InstallIn(SingletonComponent::class)
public abstract class GameDetailsModule {
    @Binds
    @Singleton
