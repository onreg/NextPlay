https://api.rawg.io/api/games?key=dummy_key&page=1

```json
{
  "count": 897744,
  "next": "https://api.rawg.io/api/games?key=dummy_key&page=2",
  "previous": null,
  "results": [
    {
      "id": 3498,
